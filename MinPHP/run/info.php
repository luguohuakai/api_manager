                ...
                <form action="?act=api&tag=<?php echo $_GET['tag']?>&type=do&op=add" method="post">
                    ...
                    <div class="form-group has-error">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="num" placeholder="接口编号" required="required" value="--">
                        </div>
                    </div>
                    <div class="form-group has-error">
                        <div class="input-group">
                    ...
                    <div class="form-group">
                        ...
                        <table class="table">
                            ...
                            <tr>
								...
								<td class="form-group has-error"><input type="text" class="form-control" name="p[paramType][]" placeholder="参数类型" required="required" value="string"></td>
                                <td>
        ...
        <div style="background:#f5f5f5;padding:20px;position:relative">
            ...
            <div style="margin-left:20px;">
                <form action="?act=api&tag=<?php echo $_GET['tag']?>&type=do&op=edit" method="post">
                    ...
                    <div class="form-group">
                        <textarea name="des" rows="1" class="form-control" placeholder="描述"><?php echo $info['des']?></textarea>
                    </div>
                    <div class="form-group" required="required">
                        <select class="form-control" name="type">
